...
/**
 * WebView composable for JS target.
 *
 * Note: This is currently a no-op implementation. WebView is not yet supported on the JS target.
 *
 * @param state The webview state holder where the Uri to load is defined.
 * @param modifier A compose modifier
 * @param captureBackPresses Not applicable on JS. Reserved for API consistency.
 * @param navigator An optional navigator object that can be used to control the WebView's
 * navigation from outside the composable.
 * @param onCreated Not called on JS as no native WebView is created.
 * @param onDispose Not called on JS as no native WebView is created.
 */
@Composable
actual fun WebView(
    state: WebViewState,
