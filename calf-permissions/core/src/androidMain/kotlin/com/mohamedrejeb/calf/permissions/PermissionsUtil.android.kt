...
internal fun Permission.toAndroidPermission(): String {
    val mapping = AndroidPermissionRegistry.getMapping(this) ?: return ""
    val sdkInt = Build.VERSION.SDK_INT
    return if (sdkInt in mapping.minSdkVersion..mapping.maxSdkVersion)
        mapping.permissionString
    else
        ""
}

internal fun Permission.isAlwaysGranted(): Boolean =
    AndroidPermissionRegistry.getMapping(this)?.alwaysGranted == true

internal fun getPermissionFromAndroidPermission(androidPermission: String): Permission? =
    AndroidPermissionRegistry.findByAndroidString(androidPermission, Build.VERSION.SDK_INT)
